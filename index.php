...
<html lang="en">
  <head>
		<title>-:-โรงเรียนทุ่งกุลาประชานุสรณ์ ยินดีต้อนรับ-:-</title>
		<meta charset="utf-8" />
				...
				<div class="col-md-8">
					<div class="navmenu"style="text-align: center;">
						<ul id="menu">
							...
							<li><a href="#project">กิจกรรม</a></li>
							<li><a href="#news">ข่าว</a></li>
							<li class="last"><a href="#contact">การติดต่อ</a></li>
			...
			<div class="container">
				<div class="row downLine">
					...
					<div class="col-md-6 text-left copy">
						<p>Copyright &copy; 2016 Timber. Crafted by <a href="http://designscrazed.org/">Designscrazed</a>. </p>
					</div>
